...
namespace Engine::Procedural {
    ...
    const uint16_t edgeTable[255] = { // Item in 0 is unused, but it serves as padding.
            ...
            0x70c, 0x605, 0x50f, 0x406, 0x30a, 0x203, 0x109
    };

    // From http://paulbourke.net/geometry/polygonise/table2.txt
    const int8_t triTable[255][13] = { // Item in 0 is unused, but it serves as padding.
